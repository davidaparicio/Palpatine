...
wm_menu () {
  ...
  local MENU_WM="whiptail --title \"Windows Manager\" --checklist  \"Which window manager to install :\" $WT_HEIGHT $WT_WIDTH $WT_MENU_HEIGHT "
  ...
  echo ${MENU_WM} > menu_wm.sh
  chmod 755 menu_wm.sh
  ./menu_wm.sh 2>"results_wm.txt"
