...
APP_WM_STAT[1]="OFF"
Ubuntu-Desktop_routine () {
    ALL_PKG_CHOOSEN+=" APP_WM_PKG[1]"
}
...
APP_WM_STAT[2]="OFF"
Kubuntu-Desktop_routine () {
    ALL_PKG_CHOOSEN+=" APP_WM_PKG[2]"
}
...
APP_WM_STAT[3]="OFF"
Lubuntu-Desktop_routine () {
    ALL_PKG_CHOOSEN+=" APP_WM_PKG[3]"
}
